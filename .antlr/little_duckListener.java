...
public interface little_duckListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link little_duckParser#pm_const}.
	 * @param ctx the parse tree
	 */
	void enterPm_const(little_duckParser.Pm_constContext ctx);
	/**
	 * Exit a parse tree produced by {@link little_duckParser#pm_const}.
	 * @param ctx the parse tree
	 */
	void exitPm_const(little_duckParser.Pm_constContext ctx);
	/**
